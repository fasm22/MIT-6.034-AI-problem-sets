...
# run_game(lambda board: minimax(board, depth=4,eval_fn=better_evaluate),
#         lambda board: minimax(board, depth=1, eval_fn=focused_evaluate))
...
HOW_MANY_HOURS_THIS_PSET_TOOK = "100"
WHAT_I_FOUND_INTERESTING = "abc"
WHAT_I_FOUND_BORING = "abc"
NAME = "abc"
EMAIL = "abc"
